<section id="business" class="business">
  <ul class="business__contents">
    <li class="business__contents__item">
      <span class="business__contents__item__title">
        ONEROOM
      </span>
  ...
  <ul class="business__contents">
    ...
    <li class="business__contents__item">
      ...
      <div class="business__contents__item__background">
        <p class="business__contents__item__background__description">私たちはモノや資源を大量に消費する暮らしと「豊かさ」の両⽴を考え、真に「豊かに住まう」という実現に向けて常に取り組んでいます。</p>
      </div>
